...
for output in layerOutputs:
	...
	for detection in output:
		...
		if confidence > args["confidence"]:
			...
			if LABELS[classID] != 'car' and LABELS[classID] != 'truck':
				continue
...
#print(x+w,y+h,"bottom-right")
#print(w,h)
#print(boxes)
#print(confidences)# ,classIDs)
#print(classIDs)
		...
		with open('yolo_points.csv', 'a') as file_P:
			...
			writeit.writerow([x,y,x,y+h,x+w,y,x+w,y+h])
	
	#writeit.columns = ['lxmin','lymin','lxmax','lymax','rxmin','rymin','rxmax','rymax']


		readcsv= pd.read_csv('yolo_points.csv')
		readcsv.columns= ['lxmin','lymin','lxmax','lymax','rxmin','rymin','rxmax','rymax']
		readcsv.to_csv('yolo_points_final.csv',index = False)
